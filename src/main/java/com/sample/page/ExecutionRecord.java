...

{
    ...
    public ExecutionRecord( String group, String name, String type, long timeStamp, long runTime, StepStatus status, String detail, Throwable t, boolean fromCache, String deviceName, String message ,String screenShot)
    ...
    public void setScreenShotPath(String sPath)

    {

                this.screenshot=sPath;
...

    {
        ...
        stringBuffer.append( "<tr><td  width=\"70%\">" );
...

        {
               ...
               // stringBuffer.append( "<span style=\"padding-right:3px; padding-top: 3px; display:inline-block;\">");

                stringBuffer.append("<a target=_blank hRef=\"").append(screenshot).append("\">");

               stringBuffer.append("<img src=\"" ).append(screenshot).append("\" style=\"width: 100%; height: 100%\"/>");

               // stringBuffer.append("<img src=\"" ).append(screenshot).append("\"/>");
        ...
        stringBuffer.append( "<td  width=\"15%\" style=\"vertical-align; bottom;\" nowrap>" ).append( timeFormat.format( new Date( timeStamp ) ) + " (" + runTime + "ms)" );
...

        {
            ...
            case FAILURE:
                ...
                stringBuffer.append( "<td   width=\"0%\" style=\"vertical-align; bottom; padding-top: 10px; \" align=\"center\"><span class=\"label label-danger\">Fail</span></td>" );

                break;

            case FAILURE_IGNORED:

                stringBuffer.append( "<td   width=\"0%\" style=\"vertical-align; bottom; padding-top: 10px; \" align=\"center\"><span class=\"label label-warning\">Ignored</span></td>" );

                break;

            case REPORT:

                stringBuffer.append( "<td  width=\"0%\" style=\"vertical-align; bottom; padding-top: 10px; \" align=\"center\"><span class=\"label label-info\">Information</span></td>" );
            ...
            case SUCCESS:
                ...
                if ( fromCache )
                    ...
                    stringBuffer.append( "<td  width=\"0%\" style=\"vertical-align; bottom; padding-top: 10px; \" align=\"center\"><span class=\"label label-success\">Pass</span></td>" );

                else

                    stringBuffer.append( "<td  width=\"0%\" style=\"vertical-align; bottom; padding-top: 10px; \" align=\"center\"><span class=\"label label-success\"><b>Pass</b></span></td>" );
...

        {
...

            {
                ...
                if ( /*status.equals( StepStatus.FAILURE ) && DataManager.instance().isArtifactEnabled( ArtifactType.FAILURE_SOURCE )*/ true )
