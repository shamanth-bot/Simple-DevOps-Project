...
import com.sample.page.data.DefaultPageData;
import com.sample.page.data.PageData;
import com.sample.page.data.PageDataContainer;
...
public abstract class AbstractPageDataProvider implements PageDataProvider
{
	...
	public void addRecord( PageData pageData, String recordType )
	{
		...
		if(((DefaultPageData)pageData).getData("scriptname")!=null&&((DefaultPageData)pageData).getData("testname")!=null) {
			TestDataManager.instance().setEmbedDataMap(((DefaultPageData)pageData).getData("scriptname"),((DefaultPageData)pageData).getData("testname"), pageData);
			TestDataManager.instance().setTestClassScriptList(((DefaultPageData)pageData).getData("scriptname"),((DefaultPageData)pageData).getData("testname"));
